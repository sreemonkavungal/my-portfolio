...
import TravelPilot from '../assets/images/TravelPilot.jpg'
...
<div className=" -mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md sm:mt-20 lg:flex-shrink-0 mx-auto items-center justify-center">
    ...
    <p className="text-base font-semibold text-gray-600">TravelPilot</p>

{/* Image Container */}
    <div className="mb-6">
    <img src={TravelPilot} alt="HTML-IMG" className="w-full h-40 object-cover rounded-md mt-5" />
    </div>

{/* Visit Site Button */}
    <a
    href="https://travelpilot.pages.dev/" target="_blank" rel="noreferrer"
...
{/* GitHub Button */}
    <a
    href="https://github.com/sreemonkavungal/TravelPilot" target="_blank" rel="noreferrer"
    className="mt-5 block w-full rounded-md bg-white border border-indigo-600 px-3 py-2 text-center text-sm font-semibold text-indigo-600 shadow-sm hover:bg-indigo-600
    focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 hover:text-white">
    GitHub Link
    </a>
    ...
    Plan, manage, and organize your trips effortlessly. Built with React JS and Tailwind CSS, 
    TravelPilot offers a clean and responsive interface to streamline your travel planning experience.
    </p>
    </div>
    </div>
